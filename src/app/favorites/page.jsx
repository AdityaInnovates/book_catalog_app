"use client";
import getUserFavorites from "@/serverActions/getUserFavorites";
...
const Favorites = () => {
  ...
  useEffect(() => {
    (async () => {
      var data = await getUserFavorites();
  ...
  return (
    <div>
      <div className="/mb-[5rem] h-[88.5vh] overflow-y-scroll pt-[2rem] px-[1rem] bg-white">
        <h3
